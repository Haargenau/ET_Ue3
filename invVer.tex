...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
    \begin{axis}[width=15cm, height=7cm, xmode=log, xmin=10, xmax=1e6, xlabel={Frequenz [Hz]}, ymin=-8, ymax=40, ylabel={Amplitude [dB]},y tick label style={grid=major}]
      \addplot table[x=Frequenz, y=dB, col sep=comma] {./csv_files/invVer_bigAmpl.csv};
      \node[label={180:{$f_g$}},draw=none] at (axis cs:20000,15) {};
      \addplot [color=black] coordinates {(20000,45) (20000,-10)};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
    \begin{axis}[disabledatascaling, width=15cm, height=7cm, xmode=log, xmin=10, xmax=1e6, xlabel={Frequenz [Hz]}, ymin=45, ymax=190, ylabel={Phase [$^\circ$]}, ytick={0,45,90,135,180},y tick label style={grid=major}]
      \addplot table[x=Frequenz, y=Phi, col sep=comma] {./csv_files/invVer_bigAmpl.csv};
      \node[label={180:{$f_g$}},draw=none] at (axis cs:20000,100) {};
      \addplot [color=black] coordinates {(20000,200) (20000,-20)};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[width=15cm, height=7cm, xmode=log, xmin=10, xmax=1e6, xlabel={Frequenz [Hz]}, ymin=-8, ymax=40, ylabel={Amplitude [dB]},y tick label style={grid=major}]
      ...
      \node[label={0:{$f_g$}},draw=none] at (axis cs:125000,25) {};
      \addplot [color=black] coordinates {(125000,45) (125000,-10)};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[disabledatascaling, width=15cm, height=7cm, xmode=log, xmin=10, xmax=1e6, xlabel={Frequenz [Hz]}, ymin=45, ymax=190, ylabel={Phase [$^\circ$]}, ytick={0,45,90,135,180}, y tick label style={grid=major}]
      ...
      \node[label={0:{$f_g$}},draw=none] at (axis cs:125000,150) {};
      \addplot [color=black] coordinates {(125000,200) (125000,-20)};
    \end{axis}
  \end{tikzpicture}
  \caption{invertierender Verst\"arker, $V=-5,47$, Phasengang}
\end{figure}
\noindent
F\"ur diese Messung wurde wie oben bereits beschrieben die Verst\"arkung um den Faktor 10 verringert. Mit der kleineren Verstärkung macht sich auch die D\"ampfung des OPVs erst eine Dekade sp\"ater bemerkbar, danach f\"allt sie jedoch genauso mit -20dB/Dek ab.
\newpage
